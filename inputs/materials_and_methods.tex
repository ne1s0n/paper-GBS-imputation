...
Alfalfa populations included elite germplasm from the Po Valley (Alfalfa-PV, \cite{annicchiarico_alfalfa_2015}) and elite germplasm adapted to Mediterranean-climate environments (Alfalfa-Med, \cite{annicchiarico_adaptation_2011}). For Alfalfa-PV, 124 parent genotypes were chosen by stratified mass selection for dry matter yield over three harvests among 4,480 densely planted genotypes grown in Lodi (northern Italy) under field conditions in 2002 and 2003. The Alfalfa-Med population comprised a sample of 154 parent genotypes derived from two cycles of free intercrossing among three outstanding populations in a multi-environment study: (i) the drought-tolerant Sardinian landrace Mamuntanas; (ii) the salt-tolerant Moroccan landrace Erfoud 1; (iii) the Australian variety SARDI 10, widely adapted across moisture-favorable and drought-prone environments. \\
